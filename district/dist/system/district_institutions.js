...
System.register(['aurelia-framework', 'aurelia-templating-resources'], function (_export, _context) {
	...
	var inject, bindable, BindingSignaler, _dec, _class, _desc, _value, _class2, _descriptor, _descriptor2, DistrictInstitutions;
	...
	return {
		...
		execute: function () {
			_export('DistrictInstitutions', DistrictInstitutions = (_dec = inject(BindingSignaler), _dec(_class = (_class2 = function () {
			...
			_export('DistrictInstitutions', DistrictInstitutions);
		}
	};
});